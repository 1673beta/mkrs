...
impl ReversiGameLite {
    pub fn new(id: String, created_at: String, started_at: Option<String>, ended_at: Option<String>, is_started: bool, is_ended: bool, user1_id: String, user2_id: String, user1: models::UserLite, user2: models::UserLite, winner_id: Option<String>, winner: models::UserLite, surrendered_user_id: Option<String>, timeout_user_id: Option<String>, black: Option<f64>, bw: String, no_irregular_rules: bool, is_llotheo: bool, can_put_everywhere: bool, looped_board: bool, time_limit_for_each_turn: f64) -> ReversiGameLite {
        ReversiGameLite {
            id,
            created_at,
            started_at,
