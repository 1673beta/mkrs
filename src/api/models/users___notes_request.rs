...
pub struct UsersNotesRequest {
    ...
    #[serde(rename = "withChannelNotes", skip_serializing_if = "Option::is_none")]
    pub with_channel_notes: Option<bool>,
...
impl UsersNotesRequest {
    pub fn new(user_id: String) -> UsersNotesRequest {
        UsersNotesRequest {
            user_id,
            with_replies: None,
            with_renotes: None,
            with_channel_notes: None,
            limit: None,
            since_id: None,
            until_id: None,
            since_date: None,
