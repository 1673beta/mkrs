...
pub struct FetchRss200Response1 {
    ...
    pub itunes: Option<models::FetchRss200Response1Itunes>,
}

impl FetchRss200Response1 {
    pub fn new(items: Vec<models::FetchRss200ResponseItemsInner>) -> FetchRss200Response1 {
